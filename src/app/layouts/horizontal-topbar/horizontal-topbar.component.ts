import { Component, ElementRef, EventEmitter, Output, ViewChild, HostListener, Renderer2 } from '@angular/core';
...
export class HorizontalTopbarComponent {
  ...
  @ViewChild('navbarNav', { static: true }) navbarNavRef!: ElementRef;
  navbarWidth: number = 0;
