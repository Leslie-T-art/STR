...
@Component({
  ...
  styleUrls: ['./apex-mixed.component.scss']
})
export class ApexMixedComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._lineChart('["--tb-primary", "--tb-success"]');
    this._multipleYAxisChart('["--tb-primary", "--tb-info", "--tb-success"]');
    this._lineAreaChart('["--tb-primary", "--tb-success"]');
    this._lineColumnAreaChart('["--tb-primary", "--tb-success", "--tb-danger"]');
  }
