...
@Component({
  ...
  templateUrl: './apex-scatter.component.html',
  styleUrls: ['./apex-scatter.component.scss']
})
export class ApexScatterComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicScatterChart('["--tb-primary", "--tb-success", "--tb-warning"]');
    this._dateTimeScatterChart('["--tb-primary", "--tb-success", "--tb-warning", "--tb-warning", "--tb-info"]');
    this._ScatterImagesChart('["--tb-primary", "--tb-danger"]');
  }
