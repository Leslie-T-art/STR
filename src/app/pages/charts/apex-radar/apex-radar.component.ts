 ...
 */
export class ApexRadarComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicRadarChart('["--tb-success"]');
    this._multipleSeriesChart('["--tb-danger", "--tb-success", "--tb-primary"]');
    this._polygonFillChart('["--tb-info"]');
