...
export class ApexLineComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicLineChart('["--tb-primary"]');
    this._zoomableTimeseriesChart('["--tb-secondary"]');
    this._lineWithDataLabelsChart('["--tb-primary", "--tb-success"]');
    this._dashedLineChart('["--tb-primary", "--tb-danger", "--tb-success"]');
    this._lineAnnotationsChart('["--tb-primary"]');
    this._SyncingLineChart('["--tb-primary"]');
    this._Syncingline2Chart('["--tb-warning"]');
    this._SyncingAreaChart('["--tb-success"]');
    this._brushLineChart('["--tb-danger"]');
    this._brushAreaChart('["--tb-info"]');
    this._stepLineChart('["--tb-success"]');
    this._gradientChart('["--tb-success"]');
    this._missingDataChart('["--tb-primary", "--tb-danger", "--tb-success"]');
  }
