...
@Component({
  ...
  templateUrl: './apex-treemap.component.html',
  styleUrls: ['./apex-treemap.component.scss']
})
export class ApexTreemapComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._differentColorChart('["--tb-success"]');
    this._MultiDimensionalChart('["--tb-primary","--tb-success"]');
    this._distributedTreemapChart('["--tb-primary", "--tb-secondary", "--tb-success", "--tb-info","--tb-warning", "--tb-danger"]');
    this._colorRangesChart('["--tb-info","--tb-danger"]');
  }
