...
@Component({
  ...
  templateUrl: './apex-boxplot.component.html',
  styleUrls: ['./apex-boxplot.component.scss']
})
export class ApexBoxplotComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicBoxChart('["--tb-primary", "--tb-info"]');
    this._scatterBoxChart('["--tb-danger", "--tb-info", "--tb-danger", "--tb-primary"]');
    this._horizontalBoxChart('["--tb-light", "--tb-card-bg-custom"]');
  }
